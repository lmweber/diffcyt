...
#' 
#' 
#' @return \code{d_medians_all_samples}: \linkS4class{SummarizedExperiment} object, where
#'   rows = clusters, columns = markers, assay = values (marker expression values). The
