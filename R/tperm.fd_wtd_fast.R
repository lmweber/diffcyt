...
# - Allow weighted permutation t-tests by including sample-specific weights in arguments
# 'weights1' and 'weights2' (i.e. 'weights1' and 'weights2' contain the weights for the
# functional data objects 'x1fd' and 'x2fd' respectively).
# - Speed improvements by using 'rowWeightedMeans', 'rowWeightedVars', and 'colMaxs'; from
# the 'matrixStats' package. (Could also use 'rowMeans' and 'rowVars' instead, if weights 
# are not needed).
#
