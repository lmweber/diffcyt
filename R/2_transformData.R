...
#' 
#' Flow and mass cytometry data should be transformed prior to clustering, since the raw 
#' data follows an approximately log-normal distribution. Transforming with a log (or
#' log-like) function brings the data closer to a normal distribution, which improves
#' clustering performance and allows positive and negative populations to be visualized
#' more clearly.
#' 
