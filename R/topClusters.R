...
#' 
#' This summary function displays the results in a more readable format. By default, the
#' \code{top_n} clusters or cluster-marker combinations are shown, ordered by adjusted
#' p-values. Optionally, cluster counts or proportions can also be included.
#' 
#' 
...
#'   cluster-marker combinations, ordered by adjusted p-values. Optionally, cluster counts
#'   or proportions are also included.
#' 
#' 
...
#' topClusters(out_DS)
#' 
topClusters <- function(res, d_counts = NULL, order = TRUE, all = FALSE, top_n = 20, 
