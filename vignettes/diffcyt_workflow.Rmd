...
# rate (FDR)
threshold <- 0.1
res_DA_all <- topClusters(out_DA, all = TRUE, format_vals = FALSE)
...
threshold <- 0.1
res_DS_all <- topClusters(out_DS, all = TRUE, format_vals = FALSE)
...
# rate (FDR)
threshold <- 0.1
table(topClusters(res_DA, all = TRUE, format_vals = FALSE)$p_adj <= threshold)
```
...
# 10% false discovery rate (FDR)
threshold <- 0.1
table(topClusters(res_DS, all = TRUE, format_vals = FALSE)$p_adj <= threshold)
```
